    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if proxy_type == "HTTP":
                ...
                with open("HTTPS.txt", "a") as file_https:
...
def non_check_closure():
    with (open("HTTP.txt", "r") as file_http, open("HTTPS.txt", "r") as file_https, open("SOCKS4.txt", "r") as file_socks4, open("SOCKS5.txt", "r") as file_socks5):
...
def main(timeout):
    try:
        ...
        # initialize files
        with open("HTTP.txt", "w"), open("SOCKS4.txt", "w"), open("SOCKS5.txt", "w"), open("HTTPS.txt", "w"), open("error.log", "w") as error_log:
